                    ...
                    <div className="lg:w-2/3 grid sm:grid-cols-2 gap-4">
                        ...
                        {mainContacts.map((item) => (
                            <a
                                key={item.label}
                                href={item.href}
                                className="group relative flex flex-col justify-between p-8 rounded-3xl bg-white border border-slate-200 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-red-100 hover:-translate-y-1"
                            >
                                <div
                        ...
                        <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex items-center gap-5 p-5 rounded-2xl bg-slate-900 text-white transition-all hover:bg-red-600 group"
                                >
